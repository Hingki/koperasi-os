...
import { RatiosView } from './ratios-view';
import { calculateAccountBalances, calculateFinancialRatios } from '@/lib/utils/accounting';
...
export default async function RatiosPage() {
  ...
  // 4. Calculate Ratios
  const ratioData = calculateFinancialRatios(balances);
    ...
    <div className="space-y-6 max-w-5xl mx-auto">
      <div className="flex items-center justify-between print:hidden">
        <div className="flex items-center gap-4">
            ...
            <div>
                <h1 className="text-2xl font-bold tracking-tight">Analisis Rasio Keuangan</h1>
                <p className="text-muted-foreground">
                    Indikator kesehatan keuangan per {new Date().toLocaleDateString('id-ID', { day: 'numeric', month: 'long', year: 'numeric' })}
                </p>
            </div>
        </div>
        <PrintButton />
