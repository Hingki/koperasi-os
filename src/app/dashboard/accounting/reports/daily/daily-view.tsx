                      ...
                      <tr key={t.id} className="border-b transition-colors hover:bg-slate-50/50">
                        ...
                        <td className="p-4 align-middle">
                          ...
                          <div className="text-xs text-slate-500 mt-0.5 flex items-center gap-2">
                            <Link href={`/dashboard/accounting/audit/inspector?id=${t.tx_reference}`}>
                              <Badge variant="outline" className="text-[10px] h-5 px-1 font-normal text-slate-400 border-slate-200 hover:border-blue-400 hover:text-blue-600 cursor-pointer transition-colors">
                                {t.tx_reference}
                              </Badge>
                            </Link>
