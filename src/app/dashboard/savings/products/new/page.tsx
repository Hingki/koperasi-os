        ...
        <form action={createSavingsProduct} className="space-y-6">
            ...
            <div className="flex flex-col space-y-4">
                <div className="flex items-center space-x-2">
                    <input type="checkbox" id="is_withdrawal_allowed" name="is_withdrawal_allowed" defaultChecked className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded" />
